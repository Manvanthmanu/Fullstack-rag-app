...
export default function BioCard({ name, bio, avatar }: BioCardProps) {
  return (
    <Card color='neutral' sx={{ width: 320, maxWidth: '100%', boxShadow: 'lg' ,backgroundColor: 'black', color: 'white' , border:'black'}}>
      <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
        <Avatar src={avatar} sx={{ '--Avatar-size': '4rem' }} />
       
        <Typography sx={{color:'white'}} level="title-lg">{name}</Typography>
      ...
      <CardOverflow sx={{ bgcolor: '#b73e1e' }}>
        <CardActions buttonFlex="1">
          <ButtonGroup variant="outlined" sx={{ bgcolor: '#b73e1e' }}>
            <Button sx={{ color: 'white', '&:hover': { bgcolor: '#763b03a2' } }} onClick={() => {
                window.open('https://wa.me/+919741405332')
            }}>Message</Button>
            <Button sx={{ color: 'white', '&:hover': { bgcolor: '#8641018f' } }}>Connect</Button>
          </ButtonGroup>
        </CardActions>
      </CardOverflow>
    </Card>
